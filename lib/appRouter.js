...
function appRouter(opts) {
    ...
    function getShopConfig(req, nosession, refreshSession) {
        //console.log(JSON.stringify(req.headers));
        return new Promise(function(resolve, reject) {
            var config = refreshSession ? null : (!nosession && req.session.shopConfig);
    ...
    router.get("/preferences", session, function(req, res) {
        getShopConfig(req, true, false).then(function(config) {
